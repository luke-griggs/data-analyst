...
export function AttachFileModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
      <div className="bg-[var(--input-background)] rounded-xl p-6 w-full max-w-md mx-4 border border-[var(--border)]">
        ...
        <div className="space-y-4">
            ...
            >
              <div className="flex flex-col items-center space-y-2">
                {file ? (
                  <div
                    className={`${
                      file ? "text-[var(--accent)]" : "text-[var(--muted)]"
                    }`}
                  >
          ...
          <div className="flex justify-end space-x-3">
            <button
              onClick={handleClose}
              className="px-4 py-2 rounded-lg text-sm font-medium text-[var(--muted)] hover:bg-[var(--muted)]/20 transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm font-medium bg-[var(--accent)] text-white hover:bg-[var(--accent)]/90 disabled:bg-[var(--muted)]/50 disabled:cursor-not-allowed transition-colors"
            >
