  ...
  ({ message, requiresScrollPadding }, ref) => {
    ...
    return (
      <div
        ...
        className={`w-full max-w-[94%] mx-auto px-2 pl-5 flex gap-4 mb-12 ${
      ...
      >
        ...
        <div
          className={`${
            message.role === "user"
              ? "max-w-[80%] bg-[var(--muted)]/20 rounded-xl px-4 py-3"
              : "w-full"
          }`}
        >
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {attachments.map((attachment, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="flex items-center gap-2 bg-muted/30 border border-muted/40 rounded-lg px-3 py-1.5 text-xs"
                  >
                    {isImage ? (
                      <svg
                        className="w-3 h-3"
